...
export default function Searchuser(props) {
   ...
   return (
      ...
      <div style={{width:"100%",height:"40vh"}}>
        ...
        >
          SEARCH for Mentor/Mentees
        </div>
        </div>
      </Parallax>
      <Card style={{ width: '100%', backgroundColor:"#242526" }}>
         <Card.Body style={{ maxWidth: "80vw", margin: "auto", backgroundColor:"#3A3B3C"}}>
            <Card.Header>
            <Row>
            <Col>
            ...
            <Row id='row' style={{margin:"10px"}}>
               {userList ? (
                  userList
                     ...
                     .map((items) => {
                        return (
                           <Col xs={12} md={6} lg={4} id='col-md-4-user' style={{minWidth:"200px"}}>
                              <Card
                                 id='user-search'
                                 border='dark'
                                 key={items.id}
