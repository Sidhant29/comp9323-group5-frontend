  ...
  return (
    <div>
      ...
      <Card style={{ width: "100%", backgroundColor:"#242526" }}>
        <Card.Body bg="dark" style={{ maxWidth: "80vw", margin: "auto", backgroundColor:"#3A3B3C"}}>
          <Card.Header>
          <Row>
          <Col>
          <h5 style={{color:"white"}}>Search by Name: </h5><InputGroup className="mb-3">
              <FormControl
                id="search-skills"
            ...
            <Col>
            <h5 style={{color:"white"}}>Search by Skills: </h5><InputGroup className="mb-3">
              <FormControl
                id="search-skills"
                aria-describedby="basic-addon3"
            ...
            <div>
              <ListGroup.Item style={{backgroundColor:"#3A3B3C"}}>
                <Form>
                  <div> <b style={{color:"white"}}>Looking For:</b><br/>
                    <Form.Check
                      inline
                      style={{color:"white"}}
                      label="mentor"
                  ...
                  .filter((contact) => {
                    return (
                      contact.title
                        .toString()
                        .toLowerCase()
                        .indexOf(keywords.toString().toLowerCase()) > -1
                    );
                  })
                  .map((items) => {
                     console.log(items)
                    return (
                      <Col xs={12} md={6} lg={5}  id="col-md-4-project" style={{minWidth:"200px"}}>
                        <Card
                          id="user-search"
                          border="dark"
                          key={items.id}
                        ...
                        >
                          ...
                          <ListGroup.Item>
                            ...
                            >
                              <LookingFor participants={items.participants} />
                            </Button>
                          </ListGroup.Item>
                          <ListGroup.Item>
                            <h5>Skills required </h5>

                            <SkillsBadge skills={items.skills} type="success" />
                          </ListGroup.Item>
                          <ListGroup.Item>{items.createdDate}</ListGroup.Item>
                        </Card>
                      </Col>
                    );
                  })
